...
param ServiceAppName string = 'aescobio-assignement-be'
param appServiceAppName string = 'aescobio-assignment-fe'
param appServicePlanName string = 'aescobio-asssignemnt-asp'
@allowed([
  'nonprod'
  'prod'
])
